...
function modules_social_auth_apple_connect_create(payload) {
  return travelarappAPI.post(`/modules/social-auth/apple/connect/`, payload.data);
}
...
function modules_social_auth_facebook_connect_create(payload) {
  return travelarappAPI.post(`/modules/social-auth/facebook/connect/`, payload.data);
}

function modules_social_auth_facebook_login_create(payload) {
  return travelarappAPI.post(`/modules/social-auth/facebook/login/`, payload.data);
}

function modules_social_auth_google_connect_create(payload) {
  return travelarappAPI.post(`/modules/social-auth/google/connect/`, payload.data);
}
...
function modules_social_auth_socialaccounts_disconnect_create(payload) {
  return travelarappAPI.post(`/modules/social-auth/socialaccounts/${payload.id}/disconnect/`, payload.data);
}
...
function rest_auth_registration_verify_email_create(payload) {
  return travelarappAPI.post(`/rest-auth/registration/verify-email/`, payload.data);
}
